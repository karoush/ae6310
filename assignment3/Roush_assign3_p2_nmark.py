...
def evaluate_governing_eqns(x):
    ...
    Return: The matrix K(x) and the vector F
    """
...
def adjoint_total_derivative(x):
    ...
    dfdu[0] = u[1]/(2* (u[0]*u[1])**0.5)
    dfdu[1] = u[0]/(2* (u[0]*u[1])**0.5)
    ...
    dRdx[1,0] = u[1]
    dRdx[0,1] = u[0] -u[1] #second column
    dRdx[1,1] = u[1] -u[0]
    dRdx[0,2] = u[1] #third column
    dRdx[1,2] = u[0] -u[1]
